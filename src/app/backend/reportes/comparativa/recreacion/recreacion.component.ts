...
export class RecreacionComponent implements OnInit {
  ...
  Todos(){
    ...
    this.firestoreService.getCollectionUnicDescDouble<RegistroCS>(path, 'dia', dia, 'services', 'Recreacion').subscribe( res => {
      this.diario = res;
    });
    this.firestoreService.getCollectionUnicMasDouble<RegistroCS>(path, 'dia', diasemi, 'services', 'Recreacion').subscribe( res => {
      this.semanal = res;
    });
    if(dia>15){
      this.firestoreService.getCollectionUnicDescDouble<RegistroCS>(path, 'qui', 2, 'services', 'Recreacion').subscribe( res => {
        this.quincenal = res;
      });
    }else{
      this.firestoreService.getCollectionUnicDescDouble<RegistroCS>(path, 'qui', 1, 'services', 'Recreacion').subscribe( res => {
        this.quincenal = res;
      });
    }
    this.firestoreService.getCollectionUnicDescDouble<RegistroCS>(path, 'mes', mes, 'services', 'Recreacion').subscribe( res => {
      this.mensual = res;
    });
    if(mes>6){
      this.firestoreService.getCollectionUnicDescDouble<RegistroCS>(path, 'sem', 2, 'services', 'Recreacion').subscribe( res => {
        this.semestral = res;
      });
    }else{
      this.firestoreService.getCollectionUnicDescDouble<RegistroCS>(path, 'sem', 1, 'services', 'Recreacion').subscribe( res => {
        this.semestral = res;
      });
    }
    this.firestoreService.getCollectionUnicDescDouble<RegistroCS>(path, 'año', año, 'services', 'Recreacion').subscribe( res => {
      this.anual = res;
    });
  }
  ...
  ESBuscarDiarioCasa(casa){
    ...
    this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'dia', dia, 'numcasa', casa, 'services', 'Recreacion').subscribe( res => {
      this.diariocasa = res;
    });
  }
  ...
  ESBuscarDiarioIndi(persona){
    ...
    const path1 = 'RegistroCS';
    this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'dia', dia, 'uid', persona, 'services', 'Recreacion').subscribe( res => {
      this.diarioindi = res;
    });
  }
  ...
  ESBuscarSemanalCasa(casa){
    ...
    const path1 = 'RegistroCS';
    this.firestoreService.getCollectionUnicMasTriple<RegistroCS>(path1, 'dia', diasem1, 'numcasa', casa, 'services', 'Recreacion').subscribe( res => {
  ...
  ESBuscarSemanalIndi(persona){
    ...
    const path1 = 'RegistroCS';
    this.firestoreService.getCollectionUnicMasTriple<RegistroCS>(path1, 'dia', diasem1, 'uid', persona, 'services', 'Recreacion').subscribe( res => {
  ...
  ESBuscarQuincenalCasa(casa){
    ...
    if(dia>15){
      ...
      this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'qui', 2, 'numcasa', casa, 'services', 'Recreacion').subscribe( res => {
      ...
      this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'qui', 1, 'numcasa', casa, 'services', 'Recreacion').subscribe( res => {
        this.quincenalcasa = res;
      });
    }
  }
  ...
  ESBuscarQuincenalIndi(persona){
    ...
    if(dia>15){
      ...
      this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'qui', 2, 'uid', persona, 'services', 'Recreacion').subscribe( res => {
      ...
      this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'qui', 1, 'uid', persona, 'services', 'Recreacion').subscribe( res => {
        this.quincenalindi = res;
      });
    }
  }
  ...
  ESBuscarMensualCasa(casa){
    ...
    const path1 = 'RegistroCS';
    this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'mes', mes, 'numcasa', casa, 'services', 'Recreacion').subscribe( res => {
  ...
  ESBuscarMensualIndi(persona){
    ...
    const path1 = 'RegistroCS';
    this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'mes', mes, 'uid', persona, 'services', 'Recreacion').subscribe( res => {
  ...
  ESBuscarSemestralCasa(casa){
    ...
    if(mes>6){
      ...
      this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'sem', 2, 'numcasa', casa, 'services', 'Recreacion').subscribe( res => {
      ...
      this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'sem', 1, 'numcasa', casa, 'services', 'Recreacion').subscribe( res => {
        this.semestralcasa = res;
      });
    }
  }
  ...
  ESBuscarSemestralIndi(persona){
    ...
    if(mes>6){
      ...
      this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'sem', 1, 'uid', persona, 'services', 'Recreacion').subscribe( res => {
      ...
      this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'sem', 2, 'uid', persona, 'services', 'Recreacion').subscribe( res => {
        this.semestralindi = res;
      });
    }
  }
  ...
  ESBuscarAnualCasa(casa){
    ...
    const path1 = 'RegistroCS';
    this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'año', año, 'numcasa', casa, 'services', 'Recreacion').subscribe( res => {
      this.anualcasa = res;
    });
  }
  ...
  ESBuscarAnualIndi(persona){
    ...
    const path1 = 'RegistroCS';
    this.firestoreService.getCollectionUnicDescTriple<RegistroCS>(path1, 'año', año, 'uid', persona, 'services', 'Recreacion').subscribe( res => {
      this.anualindi = res;
    });
  }
